...
export declare namespace SparkProtocolDataProvider {
...
export interface DataProviderInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getSpTokenTotalSupply",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getAllSpTokens",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface DataProvider extends BaseContract {
  ...
  getSpTokenTotalSupply: TypedContractMethod<
    [asset: AddressLike],
    [bigint],
    "view"
  >;

  getAllSpTokens: TypedContractMethod<
    [],
    [SparkProtocolDataProvider.TokenDataStructOutput[]],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getSpTokenTotalSupply"
  ): TypedContractMethod<[asset: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "getAllSpTokens"
  ): TypedContractMethod<
    [],
    [SparkProtocolDataProvider.TokenDataStructOutput[]],
    "view"
